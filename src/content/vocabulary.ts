...
const presets: Record<VocabularyPreset, Vocabulary> = {
  core: {
    ...
    homeTileWriteBody:
      'Начни с себя. Скажи честно, что у тебя внутри — от 10 до 280 символов.',
    homeTileSupportTitle: 'Поддержать кого-то',
    homeTileSupportBody:
      'Выбери чью-то историю и ответь так, как поддержал бы знакомого. Без оценок, только тепло.',
    homeTileAnswersTitle: 'Ответы для тебя',
    homeTileAnswersBody:
      'Сюда вернутся письма, которые напишут в ответ на твою мысль. К ним можно вернуться в любой день.',
    writeTitle: 'Поделиться тем, что внутри',
    writeSubtitle:
      'Напиши маленькую записку о том, как тебе сейчас. От 10 до 280 символов. Мы видим только текст — никаких имён и логинов.',
    writeInfoBlock:
      'Твою мысль прочитает живой человек и ответит, когда сможет. Иногда это занимает время — как письмо, которое добирается через пол-мира.',
    writeFieldLabel: 'Твоя история',
    supportTitle: 'Поддержать',
    supportSubtitle:
      'Здесь появляются истории людей, у которых день вышел чуть сложнее, чем хотелось бы. Выбери одну и ответь ей несколькими тёплыми фразами.',
    supportPageHelper:
      'Не нужно быть психологом — достаточно быть внимательным человеком. Представь, что это написал знакомый, и ответь так, как поддержал бы его.',
    supportPageAnonNote:
    ...
    homeHeroTitle: 'Интернет нового поколения',
    homeHeroSubtitle:
      '«Анонимные письма поддержки. Без лайков, ленты и регистрации. Только живые слова от людей, которые тоже что-то чувствуют.»',
    homeHeroTaglineTitle: 'Интернет без шума.',
    homeHeroTaglineSubtitle: 'Современный сервис поддержки 2026 года.',
    ...
    answersPageSubtitle:
      'Возвращайся к письмам, которые помогают выдохнуть и немножко улыбнуться, и смотри, как твои слова откликаются другим.',
    flow: {
      writeTitle: 'Ты делишься мыслью',
      writeDescription:
        'Пишешь одну честную фразу о том, как тебе сейчас. Без имени, без регистрации.',
      supportTitle: 'Ты поддерживаешь других',
      supportDescription: 'Открой раздел «Поддержать» и ответь так, как поддержал бы друга.',
      waitTitle: 'Кто-то отвечает тебе',
      waitDescription:
        'Один человек читает твою историю и пишет ответ — как если бы вы давно дружили.',
      saveTitle: 'Ответы — важные слова',
      saveDescription:
        'Ответ остаётся в разделе «Ответы». К нему можно вернуться, когда в голове снова шумно.',
    },
  },
  spark: {
    message: 'искра',
