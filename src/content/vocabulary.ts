...
const presets: Record<VocabularyPreset, Vocabulary> = {
  core: {
    ...
    homeTileWriteBody:
      'Скажи честно, как тебе сейчас. Здесь слышат внимательно, без имён и оценок.',
    homeTileSupportTitle: 'Поддержать кого-то',
    homeTileSupportBody:
      'Выбери историю другого человека и ответь несколькими тёплыми фразами поддержки.',
    homeTileAnswersTitle: 'Ответы для тебя',
    homeTileAnswersBody:
      'Сохраняй слова поддержки, которые помогают выдержать день, и смотри, чем ты делишься с другими.',
    ...
    homeHeroSubtitle:
      'Здесь можно честно написать, как ты на самом деле, и так же честно поддержать других. Без лайков, никнеймов и переписок — только анонимные письма поддержки.',
    ...
    answersPageSubtitle:
      'Возвращайся к письмам поддержки, которые помогают выдержать день, и смотри, как твои слова откликаются другим.',
    flow: {
      writeTitle: 'Ты делишься мыслью',
      writeDescription: 'Короткий честный текст без имён и контактов — просто расскажи, как тебе сейчас.',
      ...
      waitDescription: 'Один человек прочитает твою историю и постарается поддержать так, как поддержал бы друга.',
      saveTitle: 'Сохрани важные слова',
      saveDescription: 'Отмечай ответы, которые помогают выдержать день, и возвращайся к ним в разделе «Ответы».',
    },
  },
  spark: {
    message: 'искра',
