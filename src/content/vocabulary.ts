...
const presets: Record<VocabularyPreset, Vocabulary> = {
  core: {
    ...
    supportSubtitle:
      'Выбирай мысль другого человека и отвечай на неё с теплом. Иногда один абзац поддержки помогает выдержать день.',
    ...
    flow: {
      ...
      saveDescription: 'Отмечай ценные отклики и находи их позже в разделе «Отклики».',
    },
  },
  spark: {
    message: 'искра',
    ...
    flow: {
      ...
      saveDescription: 'Собирай важные слова в «Откликах», чтобы возвращаться к ним, когда захочется тепла.',
    },
  },
  pulse: {
    message: 'пульс',
    ...
    flow: {
      ...
      saveDescription: 'Сохраняй ценные отклики в «Откликах», чтобы возвращаться к ним позже.',
    },
  },
  note: {
    message: 'заметка',
    ...
    flow: {
      ...
      saveDescription: 'Сохраняй важные письма в «Откликах», чтобы перечитывать их позже.',
    },
  },
};
