...
const presets: Record<VocabularyPreset, Vocabulary> = {
  core: {
    ...
    homeTileWriteBody:
      'Напиши мысль, как тебе сейчас. Здесь слышат без оценок, имён и логина.',
    homeTileSupportTitle: 'Поддержать кого-то',
    homeTileSupportBody:
      'Выбери историю другого человека и ответь несколькими тёплыми фразами — как поддержал бы друга.',
    homeTileAnswersTitle: 'Ответы для тебя',
    homeTileAnswersBody:
      'Сохраняй слова поддержки, которые получают твои мысли. К ним можно возвращаться в тяжёлые дни.',
    writeTitle: 'Поделиться тем, что внутри',
    writeSubtitle:
      'Напиши, как тебе сейчас — от 10 до 280 символов. Всё анонимно и без регистрации.',
    writeInfoBlock:
      'Мы видим только текст — никаких имён и контактов. Твою мысль прочитает живой человек и ответит, когда сможет. Это может занять время — это нормально.',
    writeFieldLabel: 'Твоя история',
    supportTitle: 'Поддержать',
    supportSubtitle:
      'Здесь появляются мысли людей, которым сейчас особенно нужна опора. Выбери одну историю и ответь на неё несколькими тёплыми фразами.',
    supportPageHelper:
    ...
    homeHeroTitle: 'Простое место взаимной поддержки',
    homeHeroSubtitle:
      'Здесь можно честно написать, как тебе на самом деле, и так же честно поддержать другого.\nБез имён, лайков и гонки за вниманием — только тёплые письма поддержки.',
    homeHeroTaglineTitle: 'Тёплые слова рядом',
    homeHeroTaglineSubtitle: 'Делись честно — поддерживай честно.',
    ...
    flow: {
      ...
      writeDescription:
        'Пишешь пару предложений о том, как тебе сейчас. Без имён и контактов — только то, чем хочется поделиться.',
      ...
      saveDescription:
        'Письма поддержки остаются в разделе «Ответы». К ним можно вернуться, когда снова тяжело.',
    },
  },
  spark: {
    message: 'искра',
