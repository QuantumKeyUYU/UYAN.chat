        ...
        >
          <div className="space-y-4">
            ...
            <p className="text-text-secondary">
              UYAN.chat — небольшая почта тёплых слов. Сюда приходят, когда в голове застряла мысль или ощущение, и хочется отправить её в маленькое путешествие.
            </p>
            <p className="text-text-secondary">
              Кто-то на другом конце экрана прочитает твоё письмо и ответит своими строками — не алгоритм, а живой человек.
            </p>
            <p className="text-text-secondary">
              Каждое письмо проходит модерацию, чтобы пространство оставалось бережным и спокойным.
            </p>
          </div>
          <div className="rounded-2xl border border-uyan-action/30 bg-uyan-darkness/20 p-6 text-text-secondary">
            ...
            <div className="mt-4 space-y-4 text-lg">
              <p className="text-text-secondary">
                Лёгкое чувство, что где-то поблизости есть люди, которые понимают.
              </p>
              <p className="text-text-secondary">
                «Ответы» хранят слова, к которым можно заглянуть в любой странный, тревожный или просто серый день — как в коробку с любимыми письмами.
              </p>
            </div>
          </div>
        </motion.section>
